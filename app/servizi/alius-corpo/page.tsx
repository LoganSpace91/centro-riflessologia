  ...
  return (
    <>
      <Hero
        ...
        primary={{ label: 'Prenota su WhatsApp', href: getWhatsAppUrl('ALIUS corpo'), variant: 'whatsapp' }}
      ...
      <div className="container py-12">
        ...
        <div className="mt-10 flex flex-wrap gap-3">
          <a className="btn-whatsapp" href={getWhatsAppUrl('Prenotazione ALIUS corpo')}>Prenota su WhatsApp</a>
        </div>
      </div>
    </>
  )
