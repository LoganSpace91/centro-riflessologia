  ...
  return (
    <>
      <Hero
        ...
        primary={{ label: 'Scrivi su WhatsApp', href: 'https://wa.me/393494493683?text=Ciao%20Danya%2C%20vorrei%20informazioni%20sull%27approccio%20olistico' }}
      ...
      <div className="mt-10 flex flex-wrap gap-3">
        ...
        <a className="btn btn-outline" href="/contatti">Tutti i contatti</a>
      </div>
      </div>
    </>
  )
